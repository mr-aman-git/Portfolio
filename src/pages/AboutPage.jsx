      ...
      <div className=" md:p-20 ">
        ...
        >
          ...
          <main className="flex flex-wrap md:flex-nowrap px-5 gap-10 justify-around">
            ...
            <Card className=" md:pl-6 pl-4 py-2 shadow shadow-[#303b4c] md:w-[560px]">
              <div className="text-gray-200">
                ...
                <div className="pt-8 pb-5 flex gap-3 flex-wrap">
                  <div className="flex items-center md:w-[160px] w-[140px] pl-3 py-3 rounded-lg bg-gray-700 bg-opacity-50 hover:bg-opacity-70 transform hover:scale-105 transition-all duration-300 border-l-4 border-transparent hover:border-l-4 hover:border-purple-500 translate-y-0 opacity-100">
